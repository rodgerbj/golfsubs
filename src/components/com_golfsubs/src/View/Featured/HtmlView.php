...
namespace GolfsubsNamespace\Component\Golfsubs\Site\View\Featured;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function _prepareDocument()
	{
		...
		if ($menu) {
			...
			$this->params->def('page_heading', Text::_('COM_GOLFSUBS_DEFAULT_PAGE_TITLE'));
		}
